...
WebUI.waitForElementNotVisible(findTestObject('Master/Master_Agent/Page_Master Agent - Kelas Karyawan/button_Yes, close it'), 
    5)
...
WebUI.waitForElementPresent(findTestObject('Master/Master_Agent/Page_Master Agent - Kelas Karyawan/button_OK'), 8)
...
WebUI.waitForElementNotClickable(findTestObject('Master/Master_Branch/Page_Master - Kelas Karyawan/button_Save'), 8)
...
WebUI.click(findTestObject('Master/Master_Branch/Page_Master - Kelas Karyawan/button_Cancel_Edit'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Master/Master_Branch/Page_Master - Kelas Karyawan/button_Cancel_1_Edit'))
...
WebUI.waitForElementVisible(findTestObject('Master/Master_Branch/Page_Master - Kelas Karyawan/button_OK'), 3)
...
WebUI.waitForElementNotVisible(findTestObject('Master/Master_Currency/Page_Master Currency - Kelas Karyawan/button_Yes, close it'), 
    10)
...
WebUI.waitForElementVisible(findTestObject('Master/Master_Currency/Page_Master Currency - Kelas Karyawan/button_OK'), 3)
...
WebUI.waitForElementVisible(findTestObject('Master/Master_Depo/Page_Master Depo - Kelas Karyawan/button_OK'), 4)
...
WebUI.waitForElementClickable(findTestObject('Master/Master_Item/Page_Master Item - Kelas Karyawan/button_OK'), 5)
...
WebUI.waitForElementVisible(findTestObject('Master/Master_Reason/Page_Master Reason - Kelas Karyawan/button_OK'), 3)
