...
WebUI.setText(findTestObject('Master/Master_Vendor/Page_Create Vendor - Kelas Karyawan/span_Agent_input_Staging'), '555')
...
WebUI.setText(findTestObject('Master/Master_Vendor/Page_Create Vendor - Kelas Karyawan/span_Agent_input_Staging'), '5555')
...
WebUI.click(findTestObject('Master/Master_Vendor/Page_Create Vendor - Kelas Karyawan/button_DL_Logo2'))
...
WebUI.waitForElementNotVisible(findTestObject('Master/Master_Address/button_Yes, close it_Edit'), 4)
