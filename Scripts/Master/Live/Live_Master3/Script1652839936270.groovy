...
WebUI.setText(findTestObject('Master/Master_Customer/Page_Create Customer - Kelas Karyawan/Ìnput_Text_Agent_Staging'), '5555')
...
WebUI.setText(findTestObject('Master/Master_Customer/Page_Create Customer - Kelas Karyawan/Ìnput_Text_Agent_Staging'), '555')
...
WebUI.click(findTestObject('Master/Master_Truck/button_Cancel_1_Live'))

WebUI.click(findTestObject('Master/Master_Truck/button_Cancel'))

WebUI.click(findTestObject('Master/Master_Truck/button_Yes, close it_Live_Truck'))

WebUI.waitForElementNotVisible(findTestObject('Master/Master_Truck/button_Yes, close it_Live_Truck'), 3)

WebUI.waitForElementVisible(findTestObject('Master/Master_Truck/button_Create New'), 2)
