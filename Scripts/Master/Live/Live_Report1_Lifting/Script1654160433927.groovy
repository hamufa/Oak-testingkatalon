...
WebUI.setText(findTestObject('Report_Lifting/input_Loading_select2-search__field_Staging'), 'Denmark')
...
WebUI.setText(findTestObject('Report_Lifting/input_Delivery_select2-search__field_Staging'), 'Denmark')
...
WebUI.setText(findTestObject('Report_Lifting/input_Loading_select2-search__field'), 'Denmark')

WebUI.sendKeys(findTestObject('Report_Lifting/input_Loading_select2-search__field'), Keys.chord(Keys.ARROW_DOWN, Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Report_Lifting/span_Delivery_select2-selection select2-sel_67a74d'))

WebUI.setText(findTestObject('Report_Lifting/input_Delivery_select2-search__field'), 'INDONESIA')
...
WebUI.click(findTestObject('Report_Lifting/span_Loading_Live'))
