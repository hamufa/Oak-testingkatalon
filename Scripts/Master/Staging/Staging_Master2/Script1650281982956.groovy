...
WebUI.uploadFile(findTestObject('Master/Master_Customer/Page_Create Customer - Kelas Karyawan/input_logo'), 'D:\\This PC\\Dekstop\\vgl.jpg')
...
WebUI.setText(findTestObject('Master/Master_Customer/Page_Create Customer - Kelas Karyawan/Ìnput_Text_Agent_Staging'), '21231321')
...
WebUI.setText(findTestObject('Master/Master_Customer/Page_Create Customer - Kelas Karyawan/Ìnput_Text_Agent_Staging'), 'sadsadsad')
...
WebUI.setText(findTestObject('Master/Master_Customer/Page_Master Customer - Kelas Karyawan/input_Staging'), 'catdogmail')
...
WebUI.waitForElementNotVisible(findTestObject('Master/Master_Customer/Page_Master Customer - Kelas Karyawan/button_OK'), 
    8)
...
WebUI.click(findTestObject('Master/Master_Customer/Page_Master Customer - Kelas Karyawan/button_sync_Yes, close it'))

WebUI.waitForElementNotVisible(findTestObject('Master/Master_Customer/Page_Master Customer - Kelas Karyawan/button_sync_Yes, close it'), 
    8)
...
WebUI.setText(findTestObject('Master/Master_Shipping/input_shippingcode_Staging'), 'VJKT')

WebUI.sendKeys(findTestObject('Master/Master_Shipping/input_shippingcode_Staging'), Keys.chord(Keys.ENTER))
...
WebUI.setText(findTestObject('Master/Master_Shipping/input_shippingcode_Staging_Edit'), 'VJKT-2222')
...
WebUI.click(findTestObject('Master/Master_Truck/button_Edit_Cancel_1'))
...
WebUI.waitForElementVisible(findTestObject('Master/Master_Truck/button_OK'), 3)
