...
WebUI.setText(findTestObject('Master/Master_Vendor/Page_Create Vendor - Kelas Karyawan/input_Vendor_vendor_code_text_Staging'), 
    'Vendor JKT')

WebUI.sendKeys(findTestObject('Master/Master_Vendor/Page_Create Vendor - Kelas Karyawan/input_Vendor_vendor_code_text_Staging'), 
...
WebUI.setText(findTestObject('Master/Master_Vendor/Page_Create Vendor - Kelas Karyawan/payable_input_Staging'), 'bca - idr 511 016 8855')
...
WebUI.setText(findTestObject('Master/Master_Vendor/Page_Create Vendor - Kelas Karyawan/span_Agent_input_Staging'), 'sadsadsad')
...
WebUI.setText(findTestObject('Master/Master_Vendor/Page_Create Vendor - Kelas Karyawan/payable_input_Staging'), 'mandiri - idr 141 001 707 6431')
...
WebUI.setText(findTestObject('Master/Master_Vendor/Page_Create Vendor - Kelas Karyawan/span_Agent_input_Staging'), '21231321')
...
WebUI.waitForElementVisible(findTestObject('Master/Master_Address/button_OK'), 5)
...
WebUI.waitForElementNotVisible(findTestObject('Master/Master_Authorized/button_Yes, close it'), 8)
