...
WebUI.click(findTestObject('Master/Master_Customer/Page_Master Customer - Kelas Karyawan/button_CUST_CODE'))
...
WebUI.setText(findTestObject('Master/Master_Customer/Page_Create Customer - Kelas Karyawan/Ìnput_Text_Agent_Staging'), '212')
...
WebUI.setText(findTestObject('Master/Master_Customer/Page_Master Customer - Kelas Karyawan/input_Staging'), '8077186fef@catdogmail.live')
