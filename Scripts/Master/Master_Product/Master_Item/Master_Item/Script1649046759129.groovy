...
WebUI.setEncryptedText(findTestObject('Master/Master_Item/Page_Login Panel/input_Welcome to Oaktree_password'), 
...
WebUI.setText(findTestObject('Master/Master_Item/Page_Master Item - Kelas Karyawan/input_Save_select2-search__field'), 
    'Non Inventory')
...
WebUI.setText(findTestObject('Master/Master_Item/Page_Master Item - Kelas Karyawan/textarea_Remarks_remarks'), 
    '2222')
