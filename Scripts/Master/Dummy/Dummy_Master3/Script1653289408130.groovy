...
WebUI.click(findTestObject('Master/Master_Truck/button_Yes, close it_Live'))

WebUI.waitForElementVisible(findTestObject('Master/Master_Truck/button_Create New'), 4)
