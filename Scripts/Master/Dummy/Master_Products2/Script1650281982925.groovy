...
WebUI.waitForElementNotVisible(findTestObject('Master/Master_Truck/button_Edit_Yes, close it'), 8)

WebUI.waitForElementVisible(findTestObject('Master/Master_Truck/button_OK'), 8)
