...
WebUI.setText(findTestObject('Master/Master_Item/Page_Master Item - Kelas Karyawan/input__select2-search__field_Dummy'), 
    'Head Office')

WebUI.sendKeys(findTestObject('Master/Master_Item/Page_Master Item - Kelas Karyawan/input__select2-search__field_Dummy'), 
    Keys.chord(Keys.ARROW_DOWN, Keys.ENTER))
...
WebUI.setText(findTestObject('Master/Master_Item/Page_Master Item - Kelas Karyawan/input_select_Search_Dummy'), 'Deposit')

WebUI.sendKeys(findTestObject('Master/Master_Item/Page_Master Item - Kelas Karyawan/input_select_Search_Dummy'), Keys.chord(
        Keys.ARROW_DOWN, Keys.ENTER))
