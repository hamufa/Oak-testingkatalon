...
WebUI.setText(findTestObject('Master/Master_Item/Page_Master Item - Kelas Karyawan/input__select2-search__field'), 'CABANG UTAMA')
...
WebUI.waitForElementVisible(findTestObject('Master/Master_Port/Page_Master Port - Kelas Karyawan/button_OK'), 4)
