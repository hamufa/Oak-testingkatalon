...
WebUI.setText(findTestObject('Marketing_Quotation/input_POL'), 'Papua')
...
WebUI.selectOptionByValue(findTestObject('Marketing_Quotation/select_CASH ON HAND4'), '470', true)
...
WebUI.setText(findTestObject('Marketing_Quotation/input_Remark_form-control form-control-sm_2'), '22222')
...
WebUI.selectOptionByValue(findTestObject('Marketing_Quotation/select_CASH ON HAND3'), '470', true)
...
WebUI.selectOptionByValue(findTestObject('Marketing_Quotation/select_CASH ON HAND4'), '543', true)
