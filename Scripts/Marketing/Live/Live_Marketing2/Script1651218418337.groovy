...
WebUI.setText(findTestObject('Object Repository/Marketing_LeadCust_List/input_Welcome to Oaktree_email_user'), '6a1c972882@catdogmail.live')
...
WebUI.setText(findTestObject('Marketing_LeadCust_List/input_notes'), '4444')
...
WebUI.click(findTestObject('Marketing_LeadCust_List/Edit_Choose_Status'))

WebUI.setText(findTestObject('Marketing_LeadCust_List/Edit_Choose_Status_Input'), 'Prospect')

WebUI.sendKeys(findTestObject('Marketing_LeadCust_List/Edit_Choose_Status_Input'), Keys.chord(Keys.ARROW_DOWN, Keys.ENTER))

WebUI.setText(findTestObject('Marketing_LeadCust_List/Edit_Schedule_Cust_Notes'), '777')
...
WebUI.setText(findTestObject('Object Repository/Marketing_Quotation/input_Customer_vs__search'), 'PT. MAKMUR1')
...
WebUI.setText(findTestObject('Marketing_Quotation/input_POD'), 'Port')
...
WebUI.setText(findTestObject('Marketing_Quotation/input_POL'), 'Port')
...
WebUI.selectOptionByValue(findTestObject('Marketing_Quotation/select_CASH ON HAND'), '553', true)
...
WebUI.selectOptionByValue(findTestObject('Marketing_Quotation/select_CASH ON HAND2'), '554', true)
...
WebUI.selectOptionByValue(findTestObject('Marketing_Quotation/select_CASH ON HAND3'), '556', true)
...
WebUI.selectOptionByValue(findTestObject('Marketing_Quotation/select_CASH ON HAND4'), '557', true)
...
WebUI.closeWindowUrl('https://crm.oaktree.id/quotation/#')

WebUI.switchToWindowUrl('https://crm.oaktree.id/quotation/')
...
WebUI.setText(findTestObject('Object Repository/Marketing_Quotation/input_Customer_vs__search'), 'ADVANTIS')
...
WebUI.setText(findTestObject('Marketing_Quotation/input_POD'), '3333')

WebUI.sendKeys(findTestObject('Marketing_Quotation/input_POD'), Keys.chord(Keys.ARROW_DOWN, Keys.ENTER))

WebUI.setText(findTestObject('Marketing_Quotation/input_POL'), '3333')
...
WebUI.selectOptionByValue(findTestObject('Marketing_Quotation/select_CASH ON HAND'), '569', true)
...
WebUI.selectOptionByValue(findTestObject('Marketing_Quotation/select_CASH ON HAND2'), '719', true)
...
WebUI.selectOptionByValue(findTestObject('Marketing_Quotation/select_CASH ON HAND3'), '720', true)
...
WebUI.selectOptionByValue(findTestObject('Marketing_Quotation/select_CASH ON HAND4'), '721', true)
