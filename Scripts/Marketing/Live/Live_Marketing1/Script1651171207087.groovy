...
WebUI.setText(findTestObject('Object Repository/Marketing_DashBoard/input_Welcome to Oaktree_email_user'), '6a1c972882@catdogmail.live')
...
WebUI.click(findTestObject('Marketing_DashBoard/a_Marketing_Live'))
