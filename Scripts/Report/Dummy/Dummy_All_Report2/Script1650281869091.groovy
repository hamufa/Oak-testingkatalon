...
WebUI.setText(findTestObject('Report_Logistic/input_Close_select2_Logistic'), 'Logistic')

WebUI.sendKeys(findTestObject('Report_Logistic/input_Close_select2_Logistic'), Keys.chord(Keys.ARROW_DOWN, Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Report_Logistic/span_Custom_select2-selection__arrow'))

WebUI.setText(findTestObject('Report_Logistic/input_Close_select2_Monthly'), 'Monthly')

WebUI.sendKeys(findTestObject('Report_Logistic/input_Close_select2_Monthly'), Keys.chord(Keys.ARROW_DOWN, Keys.ENTER))
...
WebUI.setText(findTestObject('Object Repository/Report_ReportTopOnTIme_Delay/input_Marketing_customer'), 'kofyi')
