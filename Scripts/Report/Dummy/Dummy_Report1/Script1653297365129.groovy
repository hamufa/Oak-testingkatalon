...
WebUI.click(findTestObject('Report_Lifting/Update/Page_Report Jobfile - Kelas Karyawan/th_June 2022'))

WebUI.click(findTestObject('Report_Lifting/Update/Page_Report Jobfile - Kelas Karyawan/span_May'))

WebUI.click(findTestObject('Report_Lifting/Update/Page_Report Jobfile - Kelas Karyawan/td_1'))
...
WebUI.click(findTestObject('Report_Lifting/Update/Page_Report Jobfile - Kelas Karyawan/td_22'))

WebUI.setText(findTestObject('Report_Lifting/input_Loading_select2-search__field_Staging'), 'INDONESIA')
...
WebUI.setText(findTestObject('Report_Lifting/input_Delivery_select2-search__field_Staging'), 'ICELAND')
...
WebUI.setText(findTestObject('Report_Lifting/input_Loading_select2-search__field'), 'INDONESIA')

WebUI.sendKeys(findTestObject('Report_Lifting/input_Loading_select2-search__field'), Keys.chord(Keys.ARROW_DOWN, Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Report_Lifting/span_Delivery_select2-selection select2-sel_67a74d'))

WebUI.setText(findTestObject('Report_Lifting/input_Delivery_select2-search__field'), 'ICELAND')
...
WebUI.setText(findTestObject('Report_Lifting/input_Loading_select2-search__field_Staging'), 'ICELAND')
