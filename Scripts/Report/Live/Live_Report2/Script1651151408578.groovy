...
WebUI.setText(findTestObject('Object Repository/Report_Project/input_Welcome to Oaktree_email_user'), '6a1c972882@catdogmail.live')
...
WebUI.setText(findTestObject('Settings_Statement_Of_Account/input_Please wait a moment, your data is be_4ee5db'), '5555')
...
WebUI.setText(findTestObject('Report_Best_Customer/input_Marketing_customer'), 'dwira4')
...
WebUI.setText(findTestObject('Report_Best_Customer/input_Marketing_customer'), 'Gilang')
...
WebUI.click(findTestObject('Report_Logistic/a_Logistic_2'))
