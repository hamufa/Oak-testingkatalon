...
WebUI.setText(findTestObject('Object Repository/Report_Project/input_Welcome to Oaktree_email_user'), '8077186fef@catdogmail.live')

WebUI.setEncryptedText(findTestObject('Object Repository/Report_Project/input_Welcome to Oaktree_password'), 'PLGTm/4mhzBK/fiUUkrWmQ==')
...
WebUI.setText(findTestObject('Object Repository/Report_Logistic/input_Branch_select2-search__field'), 'CABANG UTAMA')
...
WebUI.setText(findTestObject('Report_Logistic/input_Branch_Logistic'), 'Surabaya')

WebUI.sendKeys(findTestObject('Report_Logistic/input_Branch_Logistic'), Keys.chord(Keys.ARROW_DOWN, Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Report_Logistic/span_Accounting'))

WebUI.setText(findTestObject('Report_Logistic/input_Close_select2-search__field'), 'Logistic')

WebUI.sendKeys(findTestObject('Report_Logistic/input_Close_select2-search__field'), Keys.chord(Keys.ARROW_DOWN, Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Report_Logistic/span_Custom_select2-selection__arrow'))

WebUI.setText(findTestObject('Report_Logistic/input_RangeType'), 'Monthly')

WebUI.sendKeys(findTestObject('Report_Logistic/input_RangeType'), Keys.chord(Keys.ARROW_DOWN, Keys.ENTER))
...
WebUI.setText(findTestObject('Report_Logistic/input_Branch_Logistic'), 'Logistic')
...
WebUI.setText(findTestObject('Settings_Statement_Of_Account/input_Please wait a moment, your data is be_4ee5db'), '213')
...
WebUI.setText(findTestObject('Report_Best_Customer/input_Branch_customer'), 'CABANG UTAMA')
...
WebUI.setText(findTestObject('Report_Best_Customer/input_Marketing_customer'), 'wira')
...
WebUI.setText(findTestObject('Report_Best_Customer/input_Marketing_customer'), '80')

WebUI.sendKeys(findTestObject('Report_Best_Customer/input_Marketing_customer'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Report_Best_Customer/input_Marketing_customer'), 'Leo')
...
WebUI.setText(findTestObject('Object Repository/Report_ReportTopOnTIme_Delay/input_Customer_customer'), 'yuyum')
