...
WebUI.setText(findTestObject('Settings_Accurate_Access/input_Welcome to Oaktree_email_user'), '8077186fef@catdogmail.live')
...
WebUI.setText(findTestObject('Settings_Accurate_Access/input_Text_Country'), 'CABANG UTAMA')
